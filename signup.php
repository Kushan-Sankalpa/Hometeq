...
echo "<form method=post action=signup_process.php>" ;
    echo "<table style='border: 0px'>";
        ...
        echo "<td style='border: 0px'><input type=text name=r_firstname size=35></td></tr>"; // after i sumbit this form the data of this will store in this "r_firstname" 
                                                                                            //and will send to signup_process.php
